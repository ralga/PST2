...
public class Menu extends View
{
    ...
    public void initGraphicObjects()
    {
        ...
        tabGO[3] = new Text(se, se.getW()/2 - 200, se.getH()/2 - 30, 400, 200, 100, "Jouer", "Miama.ttf");
        tabGO[2] = new Button(se, (Text)tabGO[3], 0);
        tabGO[5] = new Text(se, se.getW()/2 - 150, se.getH()/2 + 200, 300, 130, 60, "Quitter", "Miama.ttf");
